...
export default function SwitchOverview({
  ...
  return (
    <div className="border rounded-full mx-auto flex-none items-center justify-center">
      <label className="bg-white rounded-full relative inline-flex cursor-pointer items-center">
        ...
        <span
          ...
          className="text-white h-11 w-[215px] rounded-full border-2 border-white bg-slate-500 after:absolute after:left-0.5 after:top-[2px] after:h-10 after:w-28 after:rounded-full  after:bg-primary after:text-center after:transition after:content-[attr(data-unchecked-label)] peer-checked:after:translate-x-[98px] peer-checked:after:border-gray-700 after:leading-[2.5rem]  peer-checked:after:content-[attr(data-checked-label)]"
        >
          <label
            className={classNames(
              "mt-2 block cursor-pointer select-none text-secondary",
              checkedState ? "ml-5 text-left" : "mr-5 text-right "
            )}
